...
*/}}
{{- define "aws-cwl-exporter.fullname" -}}
...
Common labels
*/}}
{{- define "aws-cwl-exporter.labels" -}}
helm.sh/chart: {{ include "aws-cwl-exporter.chart" . }}
{{ include "aws-cwl-exporter.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "aws-cwl-exporter.selectorLabels" -}}
app.kubernetes.io/name: {{ include "aws-cwl-exporter.name" . }}
...
*/}}
{{- define "aws-cwl-exporter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "aws-cwl-exporter.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "aws-cwl-exporter.imagePullSecret" }}
