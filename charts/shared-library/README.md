...
The `shared-library.crd-upgrade-orchestrator` and `shared-library.crd-delete-orchestrator` templates have been provided to support optionally upgrading CRDs and or deleting them when removing a chart. There are few requirements for using them:
